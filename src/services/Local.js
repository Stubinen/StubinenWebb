let Strings ={
    sv:{
        ...
        "BeskrivFilm3" : "En dag i livet för de två butiks biträdena vid namn Dante och Randal där de irriterar kunder, diskuterar filmer och spelar hockey på butikstaket.",
        "BeskrivFilm4" : "Titeln säger allt du behöver veta om denna film.",
        "BeskrivFilm5" : "Den lapd anställde blade runner K avslöjar en sedan länge begravd hemlighet med potential att rasera vad som återstår av samhället. K:s avslöjande leder honom ut på en jakt efter Rick Deckard, en tidigare blade runner som försvann för tre decennier sedan.",
        ...
        "BeskrivFilm8" : "Hidetora vaknar upp efter en hemsk mardröm och bestämmer sig på ålders höst, genast för att han ska dela upp sitt rike mellan sina söner. Bråk utbryter dock genast mellan sönerna som känner att faderns beslut inte var genomtänkt. Ran är en av legendariska regissören Akira Kurosawas sista storfilmer",
