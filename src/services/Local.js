let Strings ={
    sv:{
        ...
        "Lösenord" : "Lösenord",
        "Logga ut" : "Logga ut",
        "BeskrivFilm1" : "Keller Dovers sexåriga dotter och hennes bästa vän försvinner spårlöst på Thanksgiving och när detektiven Lokis utredning stannar upp bestämmer sig Keller för att ta saken i egna händer.",
    ...
    en:{
        ...
        "Lösenord" : "Password",
        "Logga ut" : "Log out",
        "BeskrivFilm1" : "Keller Dover's six-year-old daughter and her best friend disappear without a trace on Thanksgiving, and when Detective Loki's investigation stops, Keller decides to take matters into his own hands.",
