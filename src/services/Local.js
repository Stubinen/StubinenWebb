let Strings ={
    sv:{
        ...
        "Lösenord" : "Lösenord",
        "Logga ut" : "Logga ut",
        "BeskrivFilm1" : "En misslyckad privatdetektiv och en inhyrd torped tvingas samarbeta för att lösa ett fall med en försvunnen ung kvinna, samt det till synes orelaterade dödsfallet av en porrstjärna. Under deras utredning avslöjar de en chockerande konspiration, som sträcker sig ända upp till de högsta makthavarna.",
    ...
    en:{
        ...
        "Lösenord" : "Password",
        "Logga ut" : "Log out",
        "BeskrivFilm1" : "A failed private detective and a hitman are forced to cooperate to solve the case of a disappeared young woman and the seemingly unrelated death of a porn star. During their investigation they reveal a shocking conspiracy that reaches to the heights of power.",
