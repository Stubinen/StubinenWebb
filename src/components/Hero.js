...
class Hero extends Component {
  ...
  render() {
    return (
        <LazyHero imageSrc={'https://api.stubinen.org/img/styrelsen2223/GruppAlt.jpg'} color="#fff" isFixed={true} opacity={0.01} minHeight='75vh' transitionDuration={1000} alt="Stubinenes styrelse">
          <div className='row'>
