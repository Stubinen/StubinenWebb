...
class PosterSection extends Component {
  constructor(props) {
    ...
    this.IMAGES = [
      ...
      {src: 'https://api.stubinen.org/img/postersHT22/TS.jpg', caption: 'Trainspotting', date: "2022-11-13",text: translate("BeskrivFilm6"), vidID :"https://www.imdb.com/video/vi2148899865/?playlistId=tt0117951&ref_=tt_ov_vi"},
