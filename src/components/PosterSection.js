...
class PosterSection extends Component {
  constructor(props) {
    ...
    this.IMAGES = [
      {src: 'https://api.stubinen.org/img/postersVT23/TGP.jpg', caption: 'Men in black', date: "2023-01-22",text: translate("BeskrivFilm1"), vidID :"https://www.imdb.com/video/vi867483161/?playlistId=tt0388473?ref_=ext_shr_lnk"},
